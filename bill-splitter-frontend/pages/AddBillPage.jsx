...
// //   const addReadingRow = () =>
// //     setSubmeterReadings([...submeterReadings, { month: "", reading: "" }]);
// //   const removeReadingRow = (i) =>
// //     setSubmeterReadings(submeterReadings.filter((_, idx) => idx !== i));

// //   const addBillRow = () =>
// //     setBills([...bills, { month: "", billNumber: "", totalUnits: "", totalBill: "" }]);
// //   const removeBillRow = (i) => setBills(bills.filter((_, idx) => idx !== i));

// //   const handleSubmit = async () => {
// //     try {
// //       await axios.post(`http://localhost:5000/api/add-bill/${houseName}`, {
...
// //       <h1 className="text-2xl font-bold mb-6">Add Bill – {houseName}</h1>
...
// //         <input
// //           className="w-full border px-3 py-2 rounded"
// //           placeholder="Non‑Submeter Person"
...
// //                 value={r.month}
// //                 onChange={(e) => handleReadingChange(i, "month", e.target.value)}
// //               />
// //               <input
// //                 type="number"
...
// //                 placeholder="Reading"
// //                 value={r.reading}
// //                 onChange={(e) => handleReadingChange(i, "reading", e.target.value)}
// //               />
// //               <button onClick={() => removeReadingRow(i)} className="text-red-500">✖</button>
// //             </div>
// //           ))}
// //           <button onClick={addReadingRow} className="bg-green-600 text-white px-4 py-2 rounded">
// //             + Add Reading
// //           </button>
// //         </div>
...
// //                 value={b.month}
// //                 onChange={(e) => handleBillChange(i, "month", e.target.value)}
// //               />
// //               <input
// //                 className="border px-2 py-1 rounded"
// //                 placeholder="Bill No"
// //                 value={b.billNumber}
// //                 onChange={(e) => handleBillChange(i, "billNumber", e.target.value)}
// //               />
// //               <input
// //                 type="number"
// //                 className="border px-2 py-1 rounded"
// //                 placeholder="Units"
// //                 value={b.totalUnits}
// //                 onChange={(e) => handleBillChange(i, "totalUnits", e.target.value)}
// //               />
// //               <input
// //                 type="number"
// //                 className="border px-2 py-1 rounded"
// //                 placeholder="Total ₹"
// //                 value={b.totalBill}
// //                 onChange={(e) => handleBillChange(i, "totalBill", e.target.value)}
// //               />
// //               <button onClick={() => removeBillRow(i)} className="text-red-500 justify-self-start">
// //                 ✖
// //               </button>
// //             </div>
// //           ))}
// //           <button onClick={addBillRow} className="bg-green-600 text-white px-4 py-2 rounded">
// //             + Add Bill
// //           </button>
// //         </div>
